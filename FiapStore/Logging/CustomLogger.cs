namespace FiapStore.Logging
{
    public class CustomLogger : ILogger
    {
        ...
        {
            var caminhoDoArquivo = @$"C:\Users\joao.gasparini\Desktop\Joao_estudos\POSGRADUACAO\Modulo 1\FiapStore-main\FiapStoree\FiapStore\bin\LOG-{DateTime.Now:yyyy-MM-dd}.txt";
